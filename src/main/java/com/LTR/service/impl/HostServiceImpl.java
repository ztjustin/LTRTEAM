...
public class HostServiceImpl implements HostService {
	...
	@Override
	public Host getOneByPlatform(Platform platform) {

		return hostJpaRepository.findByPlatform(platform);

	}

	@Override
	public List<Host> getByPlatformNull() {
		return hostJpaRepository.findByPlatformNuLL();
	}
